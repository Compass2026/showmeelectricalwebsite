 ...
 *    rules are untouched.
 */
import type { Redirect } from "@/config/redirects";
...
/**
 * Paths that were publicly reachable on the old site but were never content
 * (an Elementor artifact). Served as 410 Gone by app/global-styles/route.ts
 * so search engines drop them; nothing is redirected.
 */
export const gone: string[] = ["/global-styles"];
