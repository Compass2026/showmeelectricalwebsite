...
/** Page-level copy for /: metadata and the section headings the route renders. */
export const homePage = {
  seo: {
    /**
     * Primary keyword from the approved taxonomy: "electrician st louis"
     * (260/mo). Supporting: st louis electrician, electrical contractor st
     * louis, emergency electrician st louis (D-001; no availability claim).
     */
  ...
  services: {
    ...
    intro: "Three pathways, one standard of work. Serving the Greater St. Louis area from our shop in Affton.",
    more: { label: "See every service", href: "/services" },
    callLabel: "Call",
  },
  process: {
    eyebrow: "Our process",
    heading: "Powering your project",
    intro: "From the first free consultation to the moment the power comes on — here is how the work runs.",
  },
  about: { eyebrow: "Meet the owner", cta: { label: "More about Dan", href: "/about" } },
  testimonials: {
  ...
  area: {
    ...
    heading: "Serving the Greater St. Louis area",
    intro:
      "Based in Affton and working across the metro — from St. Louis City and County out through St. Charles, Jefferson and the surrounding communities, and across the river to Edwardsville and Belleville.",
    fallback: { text: "Not sure if you're in range?", callLabel: "Call", action: "and we'll tell you straight." },
    more: { label: "Full service area", href: "/service-area" },
  },
  finalCta: {
    heading: "Let's talk about your project",
    body: "Free consultation, straight answers and a clear scope before any work starts. Tell us what you need and we'll get you on the schedule.",
    /** Optional secondary line; rendered only when present AND the careers property exists. */
    careers: { text: "Looking to join the team instead?", label: "See our open roles" } as { text: string; label: string } | null,
  },
};
