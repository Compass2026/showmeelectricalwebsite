...
| A8 | Legal pages | ✅ page · ⬜ policy revision | Address (D-005) and terms §14 contact block applied, dates bumped to 2026-09-19. The remaining edits (www host, cookies/analytics, form-consent sentence, industrial in terms §2, SMS clarification) are one proposal in `docs/policy-revision-proposal.md` awaiting Tom. |
...
| A10 | Final content confirmation | 🟡 | Address ✅ (D-005), analytics ✅ (D-006), blog wording ✅. Still open but **not launch-blocking**: business hours (only gates availability wording), Dan's surname, founding year, photo of Dan. Launch-relevant: the policy revision (A8). |
