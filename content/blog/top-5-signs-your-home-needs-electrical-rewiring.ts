...
export const post: Article = {
  ...
  body: [
    ...
    { type: "p", text: "Here are the top 5 signs your home may need electrical rewiring, and what to do about it." },
    ...
    { type: "p", text: "Does your circuit breaker keep tripping when you use multiple devices? Or do you still have a fuse box instead of a modern breaker panel? These are both red flags. Your electrical system may not be able to keep up with today’s energy demands from computers, TVs, HVAC systems, and kitchen appliances." },
    ...
    { type: "p", text: "If you’re experiencing any of the signs above, don’t wait — faulty wiring can quickly turn into a serious safety issue. At Show Me Electrical, we specialize in residential electrical rewiring and upgrades. Our licensed electricians serve homeowners across the Greater St. Louis area, including Edwardsville and Belleville, Illinois, with safe, reliable, and code-compliant solutions." },
  ],
  flags: [],
};
